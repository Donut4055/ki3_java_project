...
public class RecruitmentPositionUI {
    ...
    private static void list() {
        try {
            String[] headers = {
                    "ID", "Tên", "Mô tả", "Lương min", "Lương max",
                    "Kinh nghiệm", "Ngày tạo", "Ngày hết hạn"
            };
    ...
    private static void add() {
        try {
            ...
            System.out.println(">>> Lỗi khi thêm vị trí: " + e.getMessage());
        }
    }
    ...
    private static void update() {
        try {
            ...
            System.out.println(">>> Lỗi khi cập nhật vị trí: " + e.getMessage());
        }
    }
    ...
    private static void delete() {
        try {
            ...
            System.out.println(">>> Lỗi khi xóa vị trí: " + e.getMessage());
        }
    }
}
